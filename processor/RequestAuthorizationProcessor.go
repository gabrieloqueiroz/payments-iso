...
type RequestAuthProcessor struct{}

func (s RequestAuthProcessor) CanProcess(mti string) bool {
	return mti == util.ConstantsUtilsInst.REQUEST_AUTHORIZATION()
}

func (s RequestAuthProcessor) ConsumerProcessor(msg *builder.MessageBuilder) string {
