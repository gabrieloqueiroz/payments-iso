...
type RequestPreAuthProcessor struct{}

func (s RequestPreAuthProcessor) CanProcess(mti string) bool {
	return mti == util.ConstantsUtilsInst.REQUEST_PRE_AUTHORIZATION()
}

func (s RequestPreAuthProcessor) ConsumerProcessor(msg *builder.MessageBuilder) string {
