...
type RequestConfirmPreAuthProcessor struct{}

func (s RequestConfirmPreAuthProcessor) CanProcess(mti string) bool {
	return mti == util.ConstantsUtilsInst.REQUEST_CONFIRM_PRE_AUTHORIZATION()
}

func (s RequestConfirmPreAuthProcessor) ConsumerProcessor(msg *builder.MessageBuilder) string {
	...
	fieldBuilderInst.SetBit52(msg)
	fieldBuilderInst.SetBit54(msg)
	fieldBuilderInst.SetBit55(msg)
